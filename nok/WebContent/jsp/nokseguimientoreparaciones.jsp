...
<%
/**
 * Objetivo	jsp Mostrar la Sección de Seguimiento de Reparaciones
 *     
 * @nombre	nokseguimientofallas.jsp                                                                                   
 * @version	1.0.0
 * @author	Ricardo Zaragoza Solis
 * @since 	27 de Enero del 2016
 *
*/ 
%>
...
<body onLoad="document.getElementById('v8').focus();">
	...
	<div id="flashcontent" align="center" width="100%" style="padding-left:-0px; z-index:300;" >
			<script language="Javascript">
                                // <![CDATA[
											var so = new FlashObject("/flash/SeguimientoReparaciones.swf", "v8", "100%", "100%", "8");
											so.addVariable("lang", "en");
											so.addVariable("enforce", "0");
											so.addParam("movie", "/flash/SeguimientoReparaciones.swf");
											so.addParam("quality", "high");
											so.addParam("bgcolor", "#FFFFFF");
											so.addParam("wmode", "transparent");
											so.addParam("align","bottom");
											so.addParam("FlashVars","SeguimientoReparaciones");
