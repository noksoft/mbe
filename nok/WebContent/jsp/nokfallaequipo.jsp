...
<%
/**
 * Objetivo	jsp Fallas de Equipo
 *     
 * @nombre	nokfallaequipo.jsp                                                                                   
 * @version	1.0.0
 * @author	Ricardo Zaragoza Solis
 * @since 	02 de Abril del 2015
 *
*/ 
%>
...
<body onLoad="document.getElementById('v8').focus();">
	...
	<div id="flashcontent" align="center" width="100%" style="padding-left:-0px; z-index:300;" >
			<script language="Javascript">
                                // <![CDATA[
											var so = new FlashObject("/flash/FallasEquipo.swf", "v8", "100%", "100%", "8");
											so.addVariable("lang", "en");
											so.addVariable("enforce", "0");
											so.addParam("movie", "/flash/FallasEquipo.swf");
											so.addParam("quality", "high");
											so.addParam("bgcolor", "#FFFFFF");
											so.addParam("wmode", "transparent");
											so.addParam("align","bottom");
											so.addParam("FlashVars","FallasEquipo");
